...
const cloneProjectdir = function(req, res, next, giturl) {
  ...
  simpleGit.clone(giturl, function(err, data) {
    if (err) {
      ...
      myPATProjectDoc.procedures = serviceUtils.patProjectData(
        userSessionDir,
        giturl,
        procedureFolderName,
        next,
      ...
      myPATProjectDoc.tasks = serviceUtils.patProjectData(
        userSessionDir,
        giturl,
        tasksFolderName,
        next,
      ...
      (myPATProjectDoc.images = serviceUtils.patProjectData(
        userSessionDir,
        giturl,
        procedureImage,
        next,
