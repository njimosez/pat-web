...
const mockFolder = {
    procedures:{name:'procedures', 'EVA1.yml':{name:'EVA1.yml', path:'sts-134/procedures/EVA1.yml'}}, 
    tasks:{name:'tasks', 'egress.yml':{name:'egress.yml', path:'sts-134/tasks/egress.yml'}}
};
const ymlProcedure = {};
const ymlTask = {};
